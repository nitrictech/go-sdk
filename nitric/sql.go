...
func NewSqlDatabase(name string, opts ...sqlDatabaseOption) (*sql.SqlClient, error) {
	...
	registerChan := defaultManager.registerResource(&v1.ResourceDeclareRequest{
