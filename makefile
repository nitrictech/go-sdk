...
generate-mocks:
	...
	@go run github.com/golang/mock/mockgen github.com/nitrictech/go-sdk/interfaces/nitric/v1 UserClient,KeyValueClient,EventClient,TopicClient,QueueClient,StorageClient,FaasClient,Faas_TriggerStreamClient > mocks/clients.go
